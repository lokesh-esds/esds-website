...
import "./SoarServices.css";
import Header from "../Header/Header";
import BgSoar from "../../images/SoarServices/BgSoar.png";
import SoarImg1 from "../../images/SoarServices/SoarImg1.png";
import ItSecurityImg from "../../images/SoarServices/ItSecurityImg.png";
import CTAButton from "../../components/ui/CtaButton/CtaButton";
import { ArrowUpRight } from "lucide-react";
import DYK from "../../images/SoarServices/DYK.png";
import EasyPay from "../../images/SoarServices/EasyPay.png";
import eMudra from "../../images/SoarServices/eMudra.png";
import sidbi from "../../images/SoarServices/sidbi.png";
import siem from "../../images/SoarServices/siem.svg";
import threatDetection from "../../images/SoarServices/threatDetection.svg";
import msirm from "../../images/SoarServices/msirm.svg";
import securityOperation from "../../images/SoarServices/securityOperation.svg";
import managedSecurity from "../../images/SoarServices/managedSecurity.svg";
import FooterFinal from "../FinalFooter/FooterFinal";
import Partner from "../Partner/Partner";
import BgVideoSoar from "../../images/SoarServices/BgVideoSoar.mp4";
...
const SoarServices = () => {
  ...
  const addToRefs = (el) => {
    if (
      ...
      el.classList.contains("managedSecurityOrchestrationCard")
    ) {
  ...
  return (
    <>
      <div className=" bg-white bg-no-repeat bg-cover bg-center relative">
        ...
        <div className="cyberSecuritySection1 relative flex flex-col items-center justify-center min-h-screen text-white">
          {/* Video Background */}
          <video
            ...
            playsInline
          >
            <source src={BgVideoSoar} type="video/mp4" />
          ...
          <div className="relative z-10 text-center px-6">
            <h1 className="text-4xl font-bold pt-60">
              Harness the power of Intelligent &{" "}
              <br className="hidden lg:block" />
              Automated IT Security with SOAR Solutions
            </h1>
            <p className="mb-5 whitespace-pre-line m-auto w-6/12 text-lg mt-4">
              ...
              seamless orchestration. Empowers your business to proactively
              manage threats, streamline operations, and create a unified
              defense strategy.
            </p>
            <div className="mb-11">
              <CTAButton
        ...
        <section className="doUKnowSection" style={{ background: "#000000" }}>
        ...
        >
          ...
          <div
            ref={containerRef}
            className="managedSecurityOrchestrationContainer "
          >
        ...
        {/* <Partner  color={"#000"} title={"The Real-World Impact of ESDS Government  Community Cloud"} logosArray={logos} /> */}
        <section className="question-answer-section">
          <p>Ready to elevate your cybersecurity defence?</p>
          {/* <Link to={"/contact-us"}>{window.innerWidth < 400 ? <button className='mobile-cta'>Unlock the power of ESDS’s advanced SOAR solutions today –  Act now!</button> :   <button className="CTA-button" data-text="Awesome">
                                <span className="actual-text">&nbsp;Unlock the power of ESDS’s advanced SOAR solutions today –  Act now!&nbsp;</span>
                                <span aria-hidden="true" className="hover-text">Unlock the power of ESDS’s advanced SOAR solutions today –  Act now!</span>
                            </button>}</Link> */}
          <CTAButton
            buttonText={
              "Unlock the power of ESDS’s advanced SOAR solutions today –  Act now!"
            }
            hoverText={
              "Unlock the power of ESDS’s advanced SOAR solutions today –  Act now!"
            }
