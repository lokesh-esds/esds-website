...
import ManagedSocServices from "./component/ManagedSecurityServices/Managed Soc Services/ManagedSocServices"
export default function Routing() {
  ...
  // console.log(currentpath)
    return (
      ...
      <Route path='/managed-soc-services' element={<Suspense fallback={<Loader/>}><ManagedSocServices/></Suspense>}></Route>
